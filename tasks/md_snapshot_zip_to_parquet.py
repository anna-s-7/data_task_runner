#!/usr/bin/env python3
"""Convert daily market snapshot zips into per-ticker parquet files.
...
into the market data tree, e.g. /data/equity_data/hkg/md_snapshot/raw.

Usage:
    python md_snapshot_zip_to_parquet.py [--market MARKET] [--asset ASSET]
...
DEFAULT_MARKET = "hkg"
DEFAULT_ASSET = "eq"
DEFAULT_SRC = Path("/home/wangfc/tmp_data")
...
def default_out(market: str, asset: str) -> Path:
    ...
    return Path(f"/data/{ASSET_DIRS[asset]}/{market}/md_snapshot/raw")
